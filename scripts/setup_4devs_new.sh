...
echo "🔧 4 Developers構成作成（新仕様）"
echo "================================"
echo "仕様: 左側CEO/Manager固定、右側4Dev均等分割"
...
tmux send-keys -t $SESSION:0.5 'clear; echo "💻 Dev3（ペイン5・右4番目）"; echo "構成確認: 右側最下部の開発者"' C-m
...
echo "5. ペイン4を上下分割 → 0（左上）、1（左下）、2（右1）、3（右2）、4（右3）、5（右4）"
