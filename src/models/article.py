...
class Article:
    ...
    def __post_init__(self):
        ...
        self.is_urgent = self.importance_score >= 10 or (
        ...
        # Backwards compatibility for source/source_name
        if (
            self.source is None
            and hasattr(self, "source_name")
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "Article":
        ...
        # Parse category enum if present
...
class SecurityVulnerability:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            else str(self.published_date),
            "modified_date": self.modified_date.isoformat()
            if self.modified_date and isinstance(self.modified_date, datetime)
            else (str(self.modified_date) if self.modified_date else None),
...
class CacheEntry:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            if isinstance(self.expire_at, datetime)
            else str(self.expire_at),
            "created_at": self.created_at.isoformat()
            if isinstance(self.created_at, datetime)
            else str(self.created_at),
        }
...
def article_from_collector_data(
    data: Dict[str, Any], category: str = None, source_name: str = None
) -> Article:
